...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_530: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_1071: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1029: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_531: (a: number, b: number) => void;
