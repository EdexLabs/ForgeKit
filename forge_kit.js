...
export class MetadataManagerWrapper {
     ...
     * @param {string} text
     * @returns {FunctionMatch | undefined}
     */
 ...
 * @returns {string}
 */
export function getSourceSlice(source, start_utf16, end_utf16) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(source, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.getSourceSlice(retptr, ptr0, len0, start_utf16, end_utf16);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred2_0 = r0;
        deferred2_1 = r1;
 ...
 * @param {string} source
 * @param {number} utf16_idx
 * @returns {boolean}
 */
export function isEscaped(source, utf16_idx) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.isEscaped(ptr0, len0, utf16_idx);
    return ret !== 0;
}
 ...
 * @param {StringList} sources
 * @returns {ParseResultList}
 */
 ...
 * @param {StringList} sources
 * @param {MetadataManagerWrapper} metadata_wrapper
 * @returns {BatchValidateResultList}
 */
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbindgen_cast_0000000000000002: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm.__wasm_bindgen_func_elem_549, __wasm_bindgen_func_elem_550);
            return addHeapObject(ret);
        },
...
function __wasm_bindgen_func_elem_550(arg0, arg1) {
    wasm.__wasm_bindgen_func_elem_550(arg0, arg1);
}
